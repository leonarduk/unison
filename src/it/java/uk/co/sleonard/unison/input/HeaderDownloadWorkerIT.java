...
public class HeaderDownloadWorkerIT {
  ...
  public static LinkedBlockingQueue<NewsArticle> populateQueueWithOneRealMessage()
    ...
    try (final Reader reader = NewsClientIT.downloadFirstMessage(); ) {
      ...
      final HeaderDownloadWorker worker =
          new HeaderDownloadWorker(
              new LinkedBlockingQueue<>(),
              new DownloaderImpl(nntpHost, queue1, newsClient1, groupReader, helper2, session2));
  ...
  public final void testStoreArticleInfo()
    ...
    final LinkedBlockingQueue<NewsArticle> queue =
        HeaderDownloadWorkerIT.populateQueueWithOneRealMessage();

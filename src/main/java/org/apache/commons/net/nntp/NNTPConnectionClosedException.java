 ...
 * response (NNTP reply code 400) to a failed NNTP command. This exception is
 * derived from IOException and therefore may be caught either as an IOException
 * or specifically as an NNTPConnectionClosedException.
 * <p>
 * <p>
 * 

...
/**
 * Factory responsible for building {@link Message} entities from downloaded {@link NewsArticle}
 * instances.
 */
public class MessageFactory {

  public Message createMessage(
      final NewsArticle article, final Topic topic, final UsenetUser poster)

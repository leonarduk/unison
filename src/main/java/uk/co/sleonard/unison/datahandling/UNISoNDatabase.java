...
public class UNISoNDatabase {
  ...
  public UNISoNDatabase(
      final NewsGroupFilter filter2,
  ...
  public void refreshDataFromDatabase() {
    ...
    this.filter.setMessagesFilter(
        this.dataQuery.getMessages(
            this.filter.getSelectedMessages(),
            this.filter.getSelectedPosters(),
            this.session,
            this.filter.getFromDate(),
            this.filter.getToDate(),
            this.filter.isFiltered(),
            this.filter.getSelectedNewsgroups(),
            this.filter.getSelectedCountries()));

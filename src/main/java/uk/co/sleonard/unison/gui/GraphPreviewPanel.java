...
/**
 * Demonstrates the use of <code>GraphZoomScrollPane</code>. This class shows off the <code>
 * VisualizationViewer</code> zooming and panning capabilities, using horizontal and vertical
 * scrollbars.
 *
 * <p>This demo also shows ToolTips on graph vertices.
 *
...
public class GraphPreviewPanel extends JPanel {
  ...
  public GraphPreviewPanel(final LinkedList<String> peopleList, final List<Relationship> links)
    ...
    final VertexIconAndShapeFunction dvisf =

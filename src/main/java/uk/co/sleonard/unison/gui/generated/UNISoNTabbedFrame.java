...
public class UNISoNTabbedFrame extends javax.swing.JFrame implements DataChangeListener {
  ...
  /** The Constant DB_URL. */
  private static final String DB_URL = "jdbc:hsqldb:file:DB/projectDB";
  ...
  private static final String GUI_ARGS[] = {
    "-driver",
    UNISoNTabbedFrame.dbDriver,
    "-url",
    UNISoNTabbedFrame.DB_URL,
    "-user",
    UNISoNTabbedFrame.dbUser,
    "-noexit"
  };
  ...
  public UNISoNTabbedFrame() throws UNISoNException {
    ...
    this.exitMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, InputEvent.CTRL_MASK));

    this.refreshDBMenuItem.setAccelerator(
        KeyStroke.getKeyStroke(KeyEvent.VK_R, InputEvent.CTRL_MASK));

    this.deleteDBMenuItem.setAccelerator(
        KeyStroke.getKeyStroke(KeyEvent.VK_DELETE, InputEvent.CTRL_MASK));

    this.showDBclientMenuItem.setAccelerator(
        KeyStroke.getKeyStroke(KeyEvent.VK_SPACE, InputEvent.CTRL_MASK));

    this.aboutMenuItem.setAccelerator(
  ...
  private void deleteDBMenuItemActionPerformed(
    ...
    final int response =
        JOptionPane.showConfirmDialog(
            this,
            "This will delete ALL the data. Are you sure?",
            "DB Refresh",
  ...
  private void exitMenuItemActionPerformed(
    ...
    final int response =
        JOptionPane.showConfirmDialog(
            this, "Are you sure?", "Exit Application", JOptionPane.YES_NO_OPTION);
  ...
  private void initComponents() {
    ...
    this.downloadNewsPanel1 =
        new uk.co.sleonard.unison.gui.generated.DownloadNewsPanel(UNISoNController.getInstance());
    ...
    this.exitMenuItem.addActionListener(
        evt -> UNISoNTabbedFrame.this.exitMenuItemActionPerformed(evt));
    ...
    this.aboutMenuItem.addActionListener(
        evt -> UNISoNTabbedFrame.this.aboutMenuItemActionPerformed(evt));
    ...
    layout.setHorizontalGroup(
        layout
            ...
            .addComponent(
                this.tabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 566, Short.MAX_VALUE));
   ...
   * @param evt the evt
   */
  private void refreshDBMenuItemActionPerformed(
      final java.awt.event.ActionEvent evt) { // GEN-FIRST:event_refreshDBMenuItemActionPerformed
    this.controller.getDatabase().refreshDataFromDatabase();
  ...
  private void showDBclientMenuItemActionPerformed(
      final java.awt.event.ActionEvent evt) { // GEN-FIRST:event_showDBclientMenuItemActionPerformed

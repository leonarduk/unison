...
public class NewsArticle {
  ...
  NewsArticle(
      ...
      final int articleNumber2,
      final Date date2,
      final String from2,
      final String subject2,
      final String references2,
      final String newsgroup)
      throws UNISoNException {
    this(articleId2, articleNumber2, date2, from2, subject2, references2, null, newsgroup, null);
  }

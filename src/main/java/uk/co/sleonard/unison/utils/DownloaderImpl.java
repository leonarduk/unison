...
public class DownloaderImpl implements Downloader {
  ...
  public DownloaderImpl() {
    this(
        UNISoNController.getInstance().getNntpHost(),
  ...
  public DownloaderImpl(
      ...
      final LinkedBlockingQueue<NewsArticle> queue1,
      final NewsClient newsClient1,
  ...
  public void addDownloadRequest(final String usenetID, final DownloadMode mode)
    ...
    FullDownloadWorker.addDownloadRequest(
        usenetID, mode, this.nntpHost, this.queue, this.newsClient, this.nntpReader, this.helper);
  }
}

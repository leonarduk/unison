...
/**
 * The Class StringUtils. </br> </br> Compression algorithm adapted from a discussion on the Sun
 * Java forums: http://forum.java.sun.com/thread.jspa?threadID=250124&messageID=926638
 *
 * @author Stephen <github@leonarduk.com>
 * @since v1.0.0
 */
...
public class StringUtils {
  ...
  public static String[] loadServerList() {
    ...
    try (final InputStream resources =
        StringUtils.class.getClassLoader().getResourceAsStream(file); ) {
      if (resources != null) {

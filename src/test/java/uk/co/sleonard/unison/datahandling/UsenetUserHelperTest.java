...
public class UsenetUserHelperTest {
  ...
  public void testParseFromField() throws Exception {
    ...
    EmailAddress expected3 =
        new EmailAddress("elton_12_nunes", "elton_12_nunes@hotmail.com", "localhost");
  ...
  /**
   * Ensures an {@link IllegalArgumentException} is thrown when neither name nor email can be
   * determined.
   */
  ...
  private List<EmailAddress> parseFromField() {
    ...
    listEmail.add(
        UsenetUserHelper.parseFromField(
            "\"Elton\" <elton_12_nunes@hotmail.com>", "localhost")); // 1
    listEmail.add(
    ...
    listEmail.add(
        UsenetUserHelper.parseFromField("<elton_12_nunes@hotmail.com>", "localhost")); // 3

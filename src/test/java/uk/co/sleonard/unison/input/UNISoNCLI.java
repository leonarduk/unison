...
public class UNISoNCLI {
  ...
  private void downloadAll(final String searchString, final String host) throws UNISoNException {
    ...
    final Set<NewsGroup> listNewsgroups =
        instance.listNewsgroups(searchString, host, instance.getNntpReader().getClient());
  ...
  private void quickDownload(
      final String arg, final Date toDate, final Date fromDate, final String host)
      throws UNISoNException {
    final UNISoNController instance = UNISoNController.getInstance();
    final Set<NewsGroup> listNewsgroups =
        instance.listNewsgroups(arg, host, instance.getNntpReader().getClient());

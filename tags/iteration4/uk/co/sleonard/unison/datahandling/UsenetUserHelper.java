...
public class UsenetUserHelper {
	...
	public static EmailAddress parseFromField(String emailString,
		...
		EmailAddress emailAddress = UsenetUserHelper.createUserByRemovingBrackets(
		...
		emailAddress = UsenetUserHelper.augmentDataAndCreateUser(null, emailString,
				null, ipAddress);
	...
	private static EmailAddress createUserByRemovingBrackets(
		...
		if (leftBracket > -1) {
			...
			emailAddress = UsenetUserHelper.augmentDataAndCreateUser(name, email,
					gender, ipAddress);
		}
		return emailAddress;
	}
